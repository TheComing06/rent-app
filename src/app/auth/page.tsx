    ...
    <>
      <div className="flex flex-col items-center justify-center gap-10">
        ...
        <div className="flex flex-col items-center justify-center gap-3.5">
          <Link href="/cabinet" className="text-black rounded-md font-bold bg-neutral-100 shadow hover:bg-neutral-300 px-3.5 py-1.5 transform hover:scale-125 duration-200 transition ease-in-out">Авторизоваться</Link>
