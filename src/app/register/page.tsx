    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center gap-10">
                ...
                <Link href="/auth" className="text-black rounded-md font-bold bg-neutral-100 shadow hover:bg-neutral-300 px-3.5 py-1.5 transform hover:scale-125 duration-200 transition ease-in-out">Зарегистрироваться</Link>
            </div>
        </>
    );
}